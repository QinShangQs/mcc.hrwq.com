...
@section('content')
    ...
    <div class="container">
        <div class="block-header">
            <h2><a href="{{route('vcourse.index')}}">视频课程</a> -> 编辑视频课程</h2>
        </div>
        <div class="card">
            <div class="card-body card-padding">
                ...
                @endif
                <form id="post_form" action="{{route('vcourse.update',['id'=>$vcourse->id])}}" method="post">
                    <input type="hidden" name="id" id="id" value="{{$vcourse->id}}">
                    {!! csrf_field() !!}
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group fg-line ">
                                ...
                                <input type="text" value="{{$vcourse->title}}" name="title"
                        ...
                        <div class="col-sm-3">
                            <div class="form-group fg-line ">
                                ...
                                <div id="uploader" class="wu-example">
                                    ...
                                    <input type="hidden" id="cover_image" name="cover" value="{{ $vcourse->cover }}"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group fg-line ">
                                <label>当前图片</label>
                                @if($vcourse->cover)
                                    <span id="preview_image" class="row"><img id="img0"
                                                                              src="{{ asset($vcourse->cover) }}"></span>
                                @else
                            ...
                            <div class="form-group fg-line ">
                                ...
                                <select class="selectpicker" size="10" name="agency_id">
                                    @foreach ($agencyArr as $key=>$item)
                                        <option value="{{$key}}"
                                                @if($vcourse->agency_id==$key) selected @endif>{{$item}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group fg-line ">
                                ...
                                <div class="m-t-10">
                                    <label class="radio radio-inline">
                                        <input type="radio" name="type" id="free" value="1"
                                               @if($vcourse->type=='1'||empty($vcourse->type)) checked @endif ><i
                                                class="input-helper"></i>
                                        免费
                                    </label>
                                    <label class="radio radio-inline">
                                        <input type="radio" name="type" value="2"
                                               @if($vcourse->type=='2') checked @endif ><i class="input-helper"></i>
                                        收费
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="row" id="price">
                        <div class="col-sm-2">
                            <div class="form-group fg-line ">
                                <label>价格</label>
                                <input type="text" value="{{$vcourse->price}}" name="price"
                                       class="form-control input-sm">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group fg-line ">
                                <label>讲师</label>
                                <input type="text" value="{{$vcourse->teacher}}" name="teacher"
                                       class="form-control input-sm">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group fg-line ">
                                ...
                                <textarea class="form-control" rows="5" placeholder=""
                                          name="teacher_intr">{{$vcourse->teacher_intr}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group fg-line ">
                                <label>当前课时</label>
                                <input type="text" value="{{$vcourse->current_class}}" name="current_class"
                                       class="form-control input-sm">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group fg-line ">
                                <label>总课时</label>
                                <input type="text" value="{{$vcourse->total_class}}" name="total_class"
                                       class="form-control input-sm">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group fg-line ">
                                <label>适合对象</label>
                                <textarea class="form-control" rows="5" placeholder=""
                                          name="suitable">{{$vcourse->suitable}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group fg-line ">
                                <label>课程目标</label>
                                <textarea class="form-control" rows="5" placeholder=""
                                          name="vcourse_obj">{{$vcourse->vcourse_obj}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group fg-line ">
                                <label>课程简介</label>
                                <textarea class="form-control" rows="5" placeholder=""
                                          name="vcourse_des">{{$vcourse->vcourse_des}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group fg-line ">
                                <label>课程作业</label>
                                <textarea class="form-control" rows="5" placeholder=""
                                          name="work">{{$vcourse->work}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                @if($vcourse->video_tran)
                                    <tr id="" class="progressContainer" style="opacity: 1;">
                                        <td class="progressName">{{$vcourse->video_original}}
                                            <div class="m-t-20">
                                                <span class="origin-video btn  btn-primary play-btn"
                                                      data-url="{{config('qiniu.DOMAIN').$vcourse->video_original}}">播放原视频</span>
                                                <span class="origin-video btn  btn-primary play-btn m-l-5" style=""
                                                      data-url="{{config('qiniu.DOMAIN').$vcourse->video_tran}}">播放转码后视频</span>
                                                <span class="origin-video btn  btn-primary play-btn m-l-5" style=""
                                                      data-url="{{config('qiniu.DOMAIN').$vcourse->video_free}}">播放试看视频</span>
                                                <span class="origin-video btn  btn-primary delete-btn m-l-5" style=""
                                                      data-keya="{{$vcourse->video_original}}"
                                                      data-keyb="{{$vcourse->video_tran}}"
                                                      data-keyf="{{$vcourse->video_free}}">删除视频</span>
                                                <input type="hidden" name="video_original"
                                                       value="{{$vcourse->video_original}}">
                                                <input type="hidden" name="video_tran" value="{{$vcourse->video_tran}}">
                                                <input type="hidden" name="video_free" value="{{$vcourse->video_free}}">
                                            </div>
                                        </td>
                        ...
                        <div class="modal fade body" id="myModal-video" tabindex="-1" role="dialog"
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group fg-line ">
                                <label>排序值
                                    <small class="c-red">(数字越大越靠前)</small>
                                </label>
                                <input type="text" value="{{$vcourse->sort}}" name="sort" placeholder=""
                                       class="form-control input-sm">
                            </div>
                        </div>
                    </div>
