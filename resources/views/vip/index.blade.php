                ...
                <form action="" method='GET'>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <a href="{{ route('vip.create') }}" class="btn btn-success btn-sm  waves-effect ">
                                <i class="zmdi zmdi-plus zmdi-hc-fw"></i>添加和会员激活码

                            </a>
                            <a href="{{ route('vip.import') }}" class="btn btn-primary btn-sm  waves-effect ">
                                导入和会员激活码
                    ...
                    <div class="row card-padding">
                        <div class="col-sm-2">
                            <div class="input-group">
                                ...
                                <div class="fg-line">
                                    <input type="text" class="form-control" placeholder="和会员激活码" name='code' value="{{ request('code') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-2">
    ...
    <script type="text/javascript">
        ...
        function del_all() {
            ...
            if(ids == "")
            {
                ...
                swal({
                    ...
                    $.ajax({
                        type: 'post',
                        url: '{{route('vip.delete')}}',
                        data: {id: ids},
                        dataType: 'json',
                        success: function (res) {
                            if(res.code == 0){
                                swal(res.message);
                                window.location.href="{{route('vip.index')}}";
                            } else {
                                swal(res.message);
                            }
                        },
        ...
        $(function() {
            $('form:first .btn-success:last').click(function() {
                ...
                $(this).attr('href', '/vip?'+ url +'&export=1');
            });
        });
    </script>
@endsection
