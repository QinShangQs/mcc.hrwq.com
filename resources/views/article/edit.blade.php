...
@section('content')
    <div class="container">
        <div class="block-header">
            <h2><a href="{{route('article')}}">文案列表</a>  -> 编辑文案</h2>
        </div>
        <div class="card">
            <div class="card-body card-padding">
                ...
                <form id="post_form" class="form-horizontal" action="{{route('article.update',['id'=>$data->id])}}" method="post">
                    {!! csrf_field() !!}
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group fg-line ">
                                <label>内容</label>
                                <textarea  id="ueditor" name="content" >{{$data->content}}</textarea>
                            </div>
                        </div>
                    </div>
