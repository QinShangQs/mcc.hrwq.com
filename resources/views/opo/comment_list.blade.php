        ...
        <div class="card">
                            ...
                            <div class="col-sm-2">                       
                                <div class="input-group form-group">
                                    <span class="input-group-addon"><i class="zmdi zmdi-search"></i></span>
                                        ...
                                        <input type="text" class="form-control" placeholder="产品名称" name='search_opo' value="{{ request('search_opo') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2">                       
            ...
            <div class="card-body table-responsive">
                <table id="data-table-selection" class="table table-striped">
                    ...
                    <tbody>
                    @if(count($opo_comments))
                        @foreach($opo_comments as $item)
                            <tr id="b{{$item->id}}">
                                <td>
                                    <div class="checkbox">
                                        <label>
                                ...
                                <td>
                                     <a href="{{ route('opo.comment_show',['id'=>$item->id]) }}" title="详情">
        ...
        function del_all() {
            ...
            if(ids == "")
            {
                ...
                swal({
                    ...
                    $.ajax({
                        type: 'post',
                        url: '{{route('opo.comment_delete')}}',
                        data: {id: ids},
                        dataType: 'json',
                        success: function (res) {
                            if(res.code == 0){
                                swal(res.message);
                                window.location.href="{{route('opo.comment')}}";
                            } else {
                                swal(res.message);
                            }
                        },
