...
@section('content')
    <div class="container">
        <div class="block-header">
            <h2><a href="{{route('coupon')}}">优惠券模板</a>  -> 添加</h2>
        </div>
        <div class="card">
            <div class="card-body card-padding">
                ...
                <form id="post_form" action="{{route('coupon.store')}}" method="post">
                    {!! csrf_field() !!}
                    <div class="row">
                        <div class="col-sm-4">
                    ...
                    <div class="row type_b type_b_1">
                        <div class="col-sm-2">
                            <div class="form-group fg-line ">
                                ...
                                <input type="text" value="{{old('full_money')}}"  name="full_money"   class="form-control input-sm" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row type_b type_b_1">
                        <div class="col-sm-2">
                            <div class="form-group fg-line ">
                                ...
                                <input type="text" value="{{old('cut_money')}}"  name="cut_money"   class="form-control input-sm" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row type_b type_b_2">
                        <div class="col-sm-2">
                            <div class="form-group fg-line ">
                                ...
                                <input type="text" value="{{old('discount')}}"  name="discount"   class="form-control input-sm" >
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group fg-line ">
                                ...
                                <select id="select_scope" class="selectpicker" name="use_scope">
                                    ...
                                    @foreach($use_scope as $k=>$v)
                                        <option value="{{ $k }}" @if($k==old('use_scope')) selected @endif>{{$v}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group fg-line ">
                                ...
                                <select id="select_period_type" class="selectpicker" name="available_period_type">
                                    ...
                                    @foreach($coupon_period_type as $k=>$v)
                                        <option value="{{ $k }}" @if($k==old('available_period_type')) selected @endif>{{$v}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row type_a type_a_1">
                        <div class="col-sm-2">
                            <div class="form-group fg-line ">
                                ...
                                <input type="text" value="{{old('available_days')}}"  name="available_days"    class="form-control input-sm" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row type_a type_a_2">
                        <div class="col-sm-2">
                            <div class="form-group fg-line ">
                                <label>有效期开始时间</label>
                                <input type="text" value="{{old('available_start_time')}}"  name="available_start_time"    class="form-control input-sm date-time-picker" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row type_a type_a_2">
                        <div class="col-sm-2">
                            <div class="form-group fg-line ">
                                <label>有效期结束时间</label>
                                <input type="text" value="{{old('available_end_time')}}"  name="available_end_time"    class="form-control input-sm date-time-picker" >
                            </div>
                        </div>
                    </div>
...
@section('script')
    <script type="text/javascript">
        $(function(){
            ...
            //适用范围默认加载
            var selected_old_val = '{!! json_encode(old("use_scope_val")) !!}';
