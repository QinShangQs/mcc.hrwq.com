...
class SmsClient{
	 ...
	 * 
	 */
	function SmsClient($url,$serialNumber,$password,$sessionKey='',$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 2, $response_timeout = 10)
	{
		$this->url = $url;
